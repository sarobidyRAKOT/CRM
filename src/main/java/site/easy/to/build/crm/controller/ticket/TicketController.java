...
import site.easy.to.build.crm.service.ticket.Ticket_supService;
...
public class TicketController {
    ...
    private final Ticket_supService ticket_supService;
    ...
    public TicketController(TicketService ticketService, AuthenticationUtils authenticationUtils, UserService userService, CustomerService customerService,
        ...
        Ticket_supService ticket_supService
    ) {
        ...
        this.ticket_supService = ticket_supService;
    }
    ...
    public String deleteTicket(@PathVariable("id") int id, Authentication authentication){
        ...
        Ticket_sup ticket_sup = new Ticket_sup();
        ticket_sup.setTicket(ticket);
        ticket_supService.save(ticket_sup);
